...
namespace AGS.Types
{
    ...
    public class Dialog : IDialog, IScript, IToXml, IComparable<IDialog>, ICloneable
    {
        ...
        */
        ...
        private const string DIALOG_DATA_FILE_EXT = "dasc";
        ...
        /// </summary>
        [Browsable(false)]
        public string DataFileName { get { return $"{ScriptName}.{DIALOG_DATA_FILE_EXT}"; } }
        ...
        public Dialog(XmlNode node)
        {
            ...
            try
            {
                fileVersion = SerializeUtils.ReadVersionAttribute(node, null, null);
            }
            catch (Exception)
            {
