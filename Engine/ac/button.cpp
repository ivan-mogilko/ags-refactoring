...
std::vector<PAnimatingButton> animbuts;
...
void Button_Animate(GUIButton *butt, int view, int loop, int speed, int repeat) {
    ...
    PAnimatingButton abtn(new AnimatingGUIButton);
...
{
    animbuts.push_back(PAnimatingButton(new AnimatingGUIButton(abtn)));
}

// returns 1 if animation finished
int UpdateAnimatingButton(int bu) {
    PAnimatingButton abtn = animbuts[bu];
