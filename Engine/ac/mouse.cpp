...
void set_mouse_cursor(int newcurs) {
    ...
    // if it's same cursor and there's animation in progress, don't assign a new pic just yet
    // TODO: for proper test, run animation in update loop instead of draw func, and set some flags
